...
class __TwigTemplate_3be199113d04679e3d2b5386dcb10123a2655806a8a080283b2026fd3470cb7b extends Template
{
  ...
  <section id=\"hero\" class=\"d-flex align-items-center\">
    ...
    <table class=\"table\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["etats"]) || array_key_exists("etats", $context) ? $context["etats"] : (function () { throw new RuntimeError('Variable "etats" does not exist.', 37, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["etat"]) {
            ...
            echo "            <tr>
                <td>";
            // line 39
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["etat"], "id", [], "any", false, false, false, 39), "html", null, true);
            echo "</td>
                <td>";
            // line 40
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["etat"], "libelle", [], "any", false, false, false, 40), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 42
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("etat_show", ["id" => twig_get_attribute($this->env, $this->source, $context["etat"], "id", [], "any", false, false, false, 42)]), "html", null, true);
            echo "\">show</a>
                    <a href=\"";
            // line 43
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("etat_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["etat"], "id", [], "any", false, false, false, 43)]), "html", null, true);
            echo "\">edit</a>
                </td>
            </tr>
        ";
...
";
    ...
    {
        return array (  171 => 54,  166 => 51,  157 => 47,  148 => 43,  144 => 42,  139 => 40,  135 => 39,  132 => 38,  127 => 37,  103 => 16,  99 => 15,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Etat index{% endblock %}
    ...
    <table class=\"table\">
        ...
        {% for etat in etats %}
            <tr>
                ...
                <td>{{ etat.libelle }}</td>
                <td>
                    <a href=\"{{ path('etat_show', {'id': etat.id}) }}\">show</a>
                    <a href=\"{{ path('etat_edit', {'id': etat.id}) }}\">edit</a>
                </td>
            </tr>
        {% else %}
            <tr>
